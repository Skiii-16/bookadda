			...
			<header className="header">
				<div className="header-BookAdda">
					...
					<div className="icons">
						...
						{!token ? (
							<Link to="/login" id="login-btn" className="login-btn-BookAdda">
						...
						<Link to="/signup" id="signUp-btn">
							<button className="btn signUp-btn-BookAdda">Signup</button>
						</Link>
					</div>
				</div>
			</header>
